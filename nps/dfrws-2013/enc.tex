...
\end{tikzpicture}
\caption{Merged search automaton for \re{Lolita} in UTF-8, UTF-16LE, and UTF-32LE}
\end{figure*}
...
%  \node[state]           (3) [right=of 0]       {};
%  \node[state,accepting] (4) [right=12em of 1]  {};
%  \node[state,accepting] (5) [right=12em of 2]  {};
%  \node[state]           (6) [right=6em of 3]   {};
%  \node[state]           (7) [below right=7em of 3] {};
%  \node[state]           (8) [above right=7em of 3] {};
...
\end{tikzpicture}  
\caption{Merged search automaton for \re{[\texteuro\$][ \whack t]*\whack d+} in ISO-8859-15 and Windows-1252}
\end{figure}
