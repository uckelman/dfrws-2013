...
\begin{tikzpicture}
  ...
  \matrix (m) [matrix of nodes,nodes in empty cells,nodes={anchor=center},column sep={3mm,between origins},row sep={8mm,between origins}]
  {
   $\cdots$ &[1ex] |[byte]| & |[byte]| & |[byte]| & |[byte]| & |[byte]| & |[byte]| & |[byte]| & |[byte]| & |[byte]| & |[byte]| & |[byte]| & |[byte]| & |[byte]| & |[byte]| & |[byte]| &[1ex] $\cdots$ \\
  };

  \draw [densely dotted] ([yshift=1em]m-1-3.north west) -- ([yshift=-1em]m-1-3.south west);
  \draw [densely dotted] ([yshift=1em]m-1-15.north east) -- ([yshift=-1em]m-1-15.south east);
...
\begin{tikzpicture}
  ...
  \draw [densely dotted] ([yshift=4em]m-1-3.north west) -- ([yshift=-1em]m-1-3.south west);
  \draw [densely dotted] ([yshift=4em]m-1-15.north east) -- ([yshift=-1em]m-1-15.south east);
...
%    \draw [densely dotted] ([yshift=2em]m-1-\x.north west) -- ([yshift=-1em]m-1-\x.south west);
  \draw [densely dotted] ([yshift=5em]m-1-3.north west) -- ([yshift=-1em]m-1-3.south west);
  \draw [densely dotted] ([yshift=5em]m-1-15.north east) -- ([yshift=-1em]m-1-15.south east);
